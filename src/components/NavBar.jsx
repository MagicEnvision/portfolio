    ...
    return (
        <div >
            ...
            hover:shadow-neutral-400 flex items-center justify-center px-[12px] mx-4 '>Social</li>
             ...
             border-neutral-800 border-[2px]  h-[30px] rounded-tl-3xl 
              rounded-bl-lg rounded-tr-lg rounded-br-3xl hover:shadow
            hover:shadow-neutral-400 flex items-center justify-center px-[12px] mx-4 '>Projects</li>
                        <li className='bg-neutral-900
             border-neutral-800 border-[2px] h-[30px] rounded-tl-3xl 
              rounded-bl-lg rounded-tr-lg rounded-br-3xl hover:shadow
            hover:shadow-neutral-400 flex items-center justify-center px-[12px] mx-4 '>Resume</li>
                        <li className='bg-neutral-900
             border-neutral-800 border-[2px] h-[30px] rounded-tl-3xl 
              rounded-bl-lg rounded-tr-lg rounded-br-3xl hover:shadow
            hover:shadow-neutral-400 flex items-center justify-center px-[12px] mx-4'>About Me</li>
                    </ul>
