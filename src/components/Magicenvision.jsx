...
const MagicEnvision = () => {
  return (
    <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 grid-rows-10 gap-4 sm:gap-6 py-5  mb-6">
      <ModelView
      ...
      <div
       ...
       hover:shadow-[0px_0px_5px_0px_#EDEDED] transition-all duration-300 w-full bg-[#060606] col-span-1 row-span-1 p-4">
        ...
        <h1 className="text-md sm:text-2xl tracking-tight text-center font-oswald font-extrabold italic ">
          Magic Envision{" "}
          <span className="text-sm sm:text-xl tracking-tight font-light">
            {""}Clothing Brand
          </span>
          <br />
        </h1>
        <div className="border-t-[1px] border-neutral-600 my-2 w-full" />
        <p className="text-md sm:text-lg leading-4 md:leading-6 font-extralight text-center tracking-tight">
          {" "}
